        ...
        <Page size="A4" style={styles.page}>
            <View style={styles.custom_header}>
                <View>
                    ...
                    <Text style={styles.margin_t}><Text style={styles.header}>Invoice No :</Text> {order?.order_number}</Text>
                    <Text style={styles.margin_t}><Text style={styles.header}>Invoice To :</Text>The Soundtrack Café Hinjawdi, Pune</Text>
                </View>
                <View>
                    <Image
                        src={logo}
...
const InvoiceGenerator = ({ show, setShow, data }) => {
    ...
    return (
        <Modal show={show} onHide={() => setShow(false)} size="lg" fullscreen>
            <Modal.Header closeButton>
                <Modal.Title>Invoice Order Preview</Modal.Title>
            </Modal.Header>
