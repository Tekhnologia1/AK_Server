...
const MenuCard = ({ image, type, name, description, price, className, onClick }) => {
    return (
        <div className={`custom_card_container ${className}`}>
            ...
            <Card className="menu_card" onClick={onClick}>
                <Card.Body className="d-flex flex-column gap-1">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="type_icon">
